...
[System.Serializable]
public partial class ValiantGunController : MonoBehaviour
{
    ...
    public virtual void LateUpdate()
    {
        if (this.TurretTarget && (this.TurretTarget.name != "ResetViewAI"))
        {
            ...
            this.transform.rotation = Quaternion.RotateTowards(this.transform.rotation, this.NewRotation, Time.deltaTime * 100);
        }
    ...
    public virtual void Update()
    {
        ...
        if (Physics.Raycast(this.Muzzle.transform.position + (this.Muzzle.transform.forward * 3), this.Muzzle.transform.forward, out hit, 300, (int) this.targetLayers))
        {
            if ((this.ValiantAI.PissedAtTC1 == 0) && hit.collider.name.Contains("TC1"))
            {
    ...
    {
        this.LineOfFire = false;
        this.TurretTarget = this.ValiantAI.target;
