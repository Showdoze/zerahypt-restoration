...
[System.Serializable]
public partial class DutvutanianPoliceAI : MonoBehaviour
{
    ...
    public virtual IEnumerator Lead()
    {
        ...
        if (this.target)
        {
            ...
            float Dist3 = Mathf.Clamp(Vector3.Distance(this.TargetLead.position, this.TargetTrace.position), 0.1f, 512);
            ...
            {
                this.TargetLead.position = this.TargetLead.position + (((this.TargetLead.forward * Dist1) * Dist2) * 0.004f);
            }
            ...
            this.TargetLead.LookAt(this.target);
            if (this.Attacking)
            {
                this.TLCol.center = new Vector3(0, 0, Dist3 * 0.3f);
                this.TLCol.size = new Vector3(8, 8, Dist3);
            }
            else
            {
                this.TLCol.center = new Vector3(0, 0, 0);
                this.TLCol.size = new Vector3(0.1f, 0.1f, 0.1f);
            }
        }
    }
    ...
    public virtual void Regenerator()
    {
        ...
        if (this.target)
        {
            ...
            if (!this.Attacking)
            {
                ...
                {
                    if (Vector3.Distance(DutvutanianNetwork.instance.PriorityWaypoint.position, this.thisTransform.position) > 500)
                    {
                        this.target = DutvutanianNetwork.instance.PriorityWaypoint;
                    }
                }
            }
            else
        ...
        ////////////////////////////[VICINITY_CHECKER]//////////////////////////////
        ////////////////////////////////////////////////////////////////////////////
        this.StartCoroutine(this.VicinityCheck());
        ////////////////////////////////////////////////////////////////////////////
        //////////////////////////////[STUCKAROONIES]///////////////////////////////
        ////////////////////////////////////////////////////////////////////////////
    ...
    public virtual IEnumerator VicinityCheck()//VPFX.startSize = VPRadius * 2;
    {
        GameObject[] gos = null;
            ...
            if (!ON.Contains("9"))
            {
                if (!this.Attacking)
                {
                    if (ON.Contains("bT"))
                    {
                        ...
                        {
                            int _1964 = this.VPRadius / 2;
                            Vector3 _1965 = this.VicinityPoint.localPosition;
                            _1965.z = _1964;
                            this.VicinityPoint.localPosition = _1965;
                        }
                    }
                    else
                    {
                        if (ON.Contains("sT"))
                        {
                            ...
                            {
                                int _1966 = this.VPRadius / 2;
                                Vector3 _1967 = this.VicinityPoint.localPosition;
                                _1967.z = _1966;
                                this.VicinityPoint.localPosition = _1967;
                            }
                        }
                        else
                        {
                            ...
                            {
                                int _1968 = this.VPRadius / 2;
                                Vector3 _1969 = this.VicinityPoint.localPosition;
                                _1969.z = _1968;
                                this.VicinityPoint.localPosition = _1969;
                            }
                        }
                    }
                }
                else
                {
                    if (this.target)
                    {
                        if (Vector3.Distance(this.VicinityPoint.position, OT.position) < (this.Dist / 2))
                        {
                            this.FoundBig = false;
                            this.FoundMedium = false;
                            this.FoundSmall = false;
                            this.VicinityPoint.localPosition = new Vector3(0, 0, this.VPRadius / 2);
                        }
                    }
                }
        ...
        if (this.Attacking)
        {
            ...
            {
                int _1970 = this.VPRadius / 2;
                Vector3 _1971 = this.VicinityPoint.localPosition;
                _1971.z = _1970;
                this.VicinityPoint.localPosition = _1971;
            }
            this.Trig.center = new Vector3(0, 0, this.VPRadius / 2);
            this.Trig.radius = this.VPRadius;
        }
        else
        {
            this.VPRadius = 750;
            ...
            {
                int _1972 = this.VPRadius / 2;
                Vector3 _1973 = this.VicinityPoint.localPosition;
                _1973.z = _1972;
                this.VicinityPoint.localPosition = _1973;
            }
            this.Trig.center = new Vector3(0, 0, this.VPRadius / 10);
            this.Trig.radius = this.VPRadius / 5;
        }
    }
